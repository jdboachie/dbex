...
function EmptyState(props: EmptyStateProps) {
  return (
    <div className={`flex flex-col gap-2 z-0 size-full border border-dashed rounded-md items-center justify-center truncate ${props.className}`}>
      {/* https://vercel.com/geist/empty-state */}
      <div className="z-0 h-fit w-2/3 mx-auto p-4 justify-center items-center flex flex-col gap-0.5">
