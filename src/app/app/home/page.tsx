...
const Page = () => {
  ...
  return (
    <ScrollArea className='h-full text-xl text-primary'>
      <div className='py-4 px-12'>Hi, {`${data?.name?.substring(0,1).toUpperCase()}${data?.name?.substring(1, data.name.length
      )} 👋`}</div>
