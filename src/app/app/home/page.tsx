  ...
  return (
    <ResizablePanel>
      <div className="relative flex flex-col items-center py-2 gap-4 px-4 font-sans">
            ...
            <div className="flex justify-between flex-col gap-3 w-1/2">
              <div className='flex gap-3 flex-col'>
                <div className="icon bg-secondary w-fit p-3 rounded-lg">
                  <DatabaseIcon className="size-4 text-[#1A9AEF]" />
                </div>
              ...
              <div className="footer flex flex-col gap-2 py-2">
          ...
          <Card className='shadow border grid col-span-3 h-full dark:bg-custom-gradient rounded-lg py-4 px-5 relative'>
            <div className="flex justify-between flex-col gap-3">
              <div className="flex flex-col gap-3 items-center">
                <div className="icon bg-secondary w-fit p-3 rounded-lg">
                  <Analytics className="size-5 text-[#1A9AEF]" />
                </div>
        ...
        <div className="w-full gap-5 relative grid grid-cols-12">
          <Card className='flex flex-row col-span-5 gap-4 shadow border rounded-lg py-4 px-5 relative"'>
            <div className="flex flex-col justify-between gap-3 w-full">
              <div className='flex gap-3 flex-col'>
                <div className="icon bg-secondary w-fit p-3 rounded-lg">
                  <TerminalWindowIcon className="size-4 text-[#1A9AEF]" />
                </div>
          ...
          <Card className='shadow border grid col-span-3 h-full bg-patternImag bg-bottom  rounded-lg py-4 px-5 relative'>
            <div className="flex justify-between flex-col gap-3">
